    ...
    let ScomDune = class ScomDune extends components_3.Module {
        constructor(parent, options) {
            ...
            this.showConfig = () => {
                ...
                if (ideToolbar) {
                    const btnSettings = (_b = (_a = ideToolbar.querySelector('#toolsStack')) === null || _a === void 0 ? void 0 : _a.querySelector('#toolbar')) === null || _b === void 0 ? void 0 : _b.firstElementChild;
                    if (btnSettings) {
                        btnSettings.click();
                        return;
                    }
            ...
            return [
                {
                    ...
                    getActions: () => {
                        ...
                        if ((containerModule === null || containerModule === void 0 ? void 0 : containerModule.getConfigurators) && containerModule.getConfigurators()[1]) {
